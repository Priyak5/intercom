...
# HTTPS outbound providers. Send.py prefers BREVO_API_KEY over RESEND_API_KEY over
# SMTP — Railway and most PaaS block outbound ports 25/465/587. Brevo lets us verify
# a single sender email (e.g. a Zoho address) without owning the domain; Resend
# requires domain verification. When both are empty, send.py falls back to smtplib
# using the SMTP_* settings above.
